...
const Faq = ({setFAQ, faq, lang}) => {
    return (
        <div className={faq ? "returnPolicy4 show404" : "returnPolicy4"} onClick={() => setFAQ(false)}>
                <div className={faq ? "returnBlock4 show404" : "returnBlock4"} onClick={(e) => e.stopPropagation()}>
