...
const Shiping = ({setShiping, shiping, lang}) => {
    return (
        <div className={shiping ? "returnPolicy1 show404" : "returnPolicy1"} onClick={() => setShiping(false)}>
            <div className={shiping ? "returnBlock1 show404" : "returnBlock1"} onClick={(e) => e.stopPropagation()}>
