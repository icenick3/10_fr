...
const BodykGirl = ({ date, date2, small, setSmall, setShowReviews, phone, lang, href, setForm }) => {
    ...
    return small ? (
        <div className="smallPageNew" onClick={() => setSmall(false)}>
            <div className="imgBlock">
                <img className="imgTs"
                     src="https://i.pinimg.com/originals/f4/ce/af/f4ceafdd040609e2e128c380192d862c.jpg" alt="" />
            </div>
            <div className="informationBlock2">
                <h2 className="h2ts">Baby body, 5 pieces - for a girl</h2>
            ...
            <div className="Zippo">
                <div className="imgContainer">
                    ...
                    <div className="imgCarContainerZippo">
                        <div className="imageCont">
                            <CarouselBoxZippo element={bodicGirl} />
                        </div>
                    </div>
                ...
                <div className="descriptionTShirt">
                    <div className="informContainer">
                        <h2 className="h2ts">Baby Bodysuit, 5-piece - for a girl</h2>
